    ...
    <section className=" mt-12">
      <div className="container p-5 mx-auto flex  justify-between items-center ">
        <div className="w-[500px] flex flex-col gap-y-6  ">
          <div>
            <h1 className="text-3xl ">Build Your Ideal</h1>
            <h2 className="text-4xl font-bold bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] bg-clip-text text-transparent">
              Development Stack
            </h2>
